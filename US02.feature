...
Then el sistema mostrará todos los datos personales del usuario,
tales como nombre, correo, contraseña y número de celular;
los cuales podrá corregir o modificar a gusto. 
